...
var
	MainForm: TMainForm;
	IniFile,Pol:string;
	Lambda,Thickness,DiffuseDetAngle,BeamRadius,DetectorRadius,POffsetSize:Extended;
		...
		begin
			...
			begin
				...
				begin
					if BeamData then
					begin
						CalculateRDiffuseBeamData(Lambda,Thickness,DiffuseDetAngle,rDiffuseS,rDiffuseP);
					...
					begin
						rDiffuse:=CalculateRDiffuse(Lambda,Thickness,DiffuseDetAngle*Pi/180);
						...
						begin
							...
							begin
								if BeamData then
									...
									rDiffuse:=CalculateRDiffuse(thisLambda,Thickness,thisDetAngle);
							end;
							if Valid and Started then
							begin
								...
								begin
									...
									Cells[3,i]:=FloatToStr(thisRCollimatedS);
									Cells[4,i]:=FloatToStr(thisRCollimatedP);
									Cells[5,i]:=FloatToStr(rDiffuse);
									Cells[6,i]:=FloatToStr(rDiffuse);
								end;
								with GraphWindow do
								begin
